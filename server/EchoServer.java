...
public class EchoServer {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(myURL + ": EchoServer esta escuchando y en espera de conexiones (puerto: 1007)");
            ...
            while(listening) // bucle infinito
            {
                ...
                {    
                    if(inputline.equals("adios")){ 
                       System.out.println ("Finalizada conexion con el cliente");
                       os.println("");
                       break;
                    }else{
                    if(eo.i == 0){
                            System.out.println(eo.pago(inputline));
                            os.println("");
                            os.flush();
                    }else{
                        os.println(eo.pago(inputline));//escribimos en el socket lo recibido mas mensaje
